...
# Project name
PROJECT_NAME = 'Enercoop_WGAN_80_20'
...
MODEL_PATH = None #Path(r"/home/users/pmascherbauer/projects4/workspace_philippm/GAN/runs/WGAN_80_20/devoted-dream-386_2025-05-19-100127421/models/epoch_3728") / "epoch_3728.pt"
...
if __name__ == '__main__':
    ...
    run(params, MODEL_TYPE, PROJECT_NAME, train_data, LOG_STATS, USE_WANDB, MODEL_PATH, CREATE_DATA, generate_n_profiles = 100, train_data = train_data, holdout_data = test_data)